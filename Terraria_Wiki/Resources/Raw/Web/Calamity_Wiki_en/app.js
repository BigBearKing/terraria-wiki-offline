...
window.wikiApp.start({
    homePage: "Calamity Mod Wiki",
    headingId: "firstHeading",
    homeHeadingId: "firstHeading",
    lastModifiedPrefix: "This page was last edited on ",
    homePageClass: "rootpage-Calamity_Mod_Wiki",
    openImageLinks: true,
    sourceUrl: (title) => "https://calamitymod.wiki.gg/wiki/" + encodeURIComponent(title.replace(/ /g, "_")),
    refresh
});
